...
function preload()
{
lionimg=loadAnimation("car.gif")
bgimg=loadImage("staright road.png")
rockimg=loadImage("rock.png")
gameOverimg=loadImage("game.png")
restartimg=loadImage("restart.png")
sadlionimg=loadAnimation("sad lion.gif")
}
...
lion=createSprite(100,250,100,100)
lion.addAnimation("running",lionimg)
lion.addAnimation("sad",sadlionimg)
lion.scale=0.4

invisibleGround=createSprite(100,395,100,10)
